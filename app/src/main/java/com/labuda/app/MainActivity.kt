...
private fun formatBytes(b:Long):String{if(b<1024)return "$b Б";if(b<1024*1024)return "%.1f КБ".format(b/1024.0);if(b<1024*1024*1024)return "%.1f МБ".format(b/(1024.0*1024.0));return "%.2f ГБ".format(b/(1024.0*1024.0*1024.0))}
private fun formatExpiry(ms:Long):String=SimpleDateFormat("dd.MM.yyyy HH:mm",Locale.getDefault()).format(Date(ms))
